...
import { Button, Navigation, PanelSection } from "@decky/ui";
import { FaCog, FaExpand, FaRobot } from "react-icons/fa";
...
export default definePlugin(() => {
	...
	return {
		...
		titleView: (
			<div style={{ padding: "8px", fontSize: "1.2em" }}>AI‑ssistant Deck</div>
		),
		content: (
